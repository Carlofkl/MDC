...
def get_sd_model(args):
    ...
    if args.version == '1-4':
        ...
        scheduler = EulerDiscreteScheduler.from_pretrained(pretrained_model_name_or_path='/home/fkl/.cache/huggingface/hub/models--stabilityai--stable-diffusion-2-1-base/snapshots/5ede9e4bf3e3fd1cb0ef2f7a3fff13ee514fdf06/scheduler/scheduler_config.json', subfolder="scheduler")
        pipe = StableDiffusionPipeline.from_pretrained(pretrained_model_name_or_path=posixpath.abspath('/home/fkl/.cache/huggingface/hub/models--stabilityai--stable-diffusion-2-1-base/snapshots/5ede9e4bf3e3fd1cb0ef2f7a3fff13ee514fdf06'), scheduler=scheduler, torch_dtype=dtype)
